...
function d7_basic_color_breadcrumb($vars) {
...
/*
function d7_basic_color_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/

function d7_basic_color_preprocess_page(&$vars,$hook) {
...
/*
function d7_basic_color_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function d7_basic_color_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_basic_color_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_basic_color_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function d7_basic_color_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function d7_basic_color_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/

function d7_basic_color_form_search_block_form_alter(&$form, &$form_state, $form_id) {
